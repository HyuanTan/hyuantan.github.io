...
I am Huoyuan Tan, recently graduated with an M.Sc. in Computer Science and Engineering from the [University of Gothenburg](https://www.gu.se), with **5+ years** of industry experience as an Algorithm Engineer in autonomous mobile robotic systems. My thesis — *Assessment & Failure Recovery in Remote Vision-Language-Action (VLA) Deployment* — was supervised by Ze Zhang, in collaboration with Yajing Zhang.
